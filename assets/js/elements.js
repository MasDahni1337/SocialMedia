  ...
  if ($('#elements-page').length) {
    ...
    $(function () {
      ...
      $.fancyConfirm = function (opts) {
        ...
        $.fancybox.open({
          type: "html",
          src: '<div class="fancybox-confirm fc-content p-5 rounded">' + '<h2 class="title mb-10">' + opts.title + "</h2>" + "<p>" + opts.message + "</p>" + '<p class="text-right buttons mt-10">' + '<a data-value="0" data-fancybox-close href="javascript:;" class="button">' + opts.noButton + "</a>" + '<button data-value="1" data-fancybox-close class="button is-solid primary-button raised">' + opts.okButton + "</button>" + "</p>" + "</div>",
          opts: {
